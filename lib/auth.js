...
const AUTH_SECRET = process.env.COACHSET_AUTH_SECRET || process.env.AUTH_SECRET;
if (!AUTH_SECRET) {
  throw new Error('COACHSET_AUTH_SECRET environment variable is required. Set a strong random string.');
}
