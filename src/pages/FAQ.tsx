...
const faqs = [
  {
    ...
    answer: 'Use CoachSet Discover to filter by your city, goal, budget, and gender preference. Every trainer is identity-verified before they appear on the platform. Browse profiles, compare pricing, and send a free inquiry.'
  },
  {
    question: 'How much does a personal trainer cost in Pakistan?',
    answer: 'Prices vary widely by city, experience, and training mode. Based on market rates in Pakistan, in-person training typically ranges from PKR 15,000-40,000 per month. Online coaching is usually 40-60% cheaper. Home visit training tends to cost 20-30% more than gym sessions. Check individual trainer profiles on CoachSet for exact pricing.'
  },
  {
    question: 'Are the trainers verified?',
    answer: 'Yes. Every trainer submits CNIC and certifications. CoachSet reviews each application before approval. Verified trainers display a green checkmark badge on their profile.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Open a dispute from your client dashboard within 7 days of your first session. CoachSet reviews each case and offers resolution options including trainer replacement where possible.'
  },
  {
  ...
  {
    question: 'How do I become a trainer on CoachSet?',
    ...
    <PageShell>
      <PageContainer>
        <SEO
          ...
          canonical="https://coachset-pakistan.vercel.app/faq"
        />

        <HeroBlock
          kicker="Support"
          title="Frequently asked questions"
          description="Everything you need to know about finding, booking, and working with trainers on CoachSet."
        />
